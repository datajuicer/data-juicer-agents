...
class DJSessionAgent:
    ...
    def _session_sys_prompt(self) -> str:
        ...
        return (
            ...
            "After assemble_plan, pass the full returned plan object into plan_validate and plan_save. When calling plan_save, also provide an explicit output_path and always set overwrite=true to avoid file-exists errors.\n"
