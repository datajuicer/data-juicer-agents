...
[架构文档](./docs/overview_ZH.md) • [快速开始](./docs/quick_start_ZH.md) • [CLI 文档](./docs/cli_ZH.md) • [工具文档](./docs/tools_ZH.md)
</div>
...
Data-Juicer Agents 采用 **多智能体路由架构** 来将用户请求路由到合适的智能体。详见 [架构概览](./docs/overview_ZH.md)。
...
请参考[快速开始](./docs/quick_start_ZH.md) 在本地启动 DJX。

如果在使用过程中遇到任何问题，可以先查看[常见问题](#常见问题)，或前往文档页面向我们的问答 Copilot ***Juicer*** 提问。

#### DJX 当前文档（完整）

- 架构概览：[`docs/overview_ZH.md`](./docs/overview_ZH.md)
- 快速开始：[`docs/quick_start_ZH.md`](./docs/quick_start_ZH.md)
- CLI 参考：[`docs/cli_ZH.md`](./docs/cli_ZH.md)
